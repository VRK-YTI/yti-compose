...
#----------------------------------
#----------------------------------
docker exec yti-postgres psql -U postgres -d groupmanagement -c "INSERT INTO public.organization (id,name_en,name_fi,name_sv) VALUES ('7d3a3c00-5a6b-489b-a3ed-63bb58c26a63','Interoperability platform developers','Yhteentoimivuusalustan yllapito','Utvecklare av interoperabilitetsplattform')"
#----------------------------------
#----------------------------------
